...
import org.medibloc.panacea.crypto.*;
...
public class KeyHolder {
    ...
    public ECKeyPair getKeyPair(String password) throws Exception {
        ...
        if (kdfParams instanceof ScryptKdfParams) {
            derivedKey = getDerivedKey(password, (ScryptKdfParams)kdfParams);
        } else {
            throw new IllegalArgumentException("Unsupported kdf");
        }
